...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # The argument in inject acts as the first value of the variable in the block section. Once the first 'iteration' has been calculated, that value becomes the first argument in the block. 
    # The argument is optional  http://blog.jayfields.com/2008/03/ruby-inject.html 
  end
  ...
  #   # code to read 'file'
  # Perhaps because we do not want to change the original file

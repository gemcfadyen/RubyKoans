...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # You can use __send__ if the name 'send' clashes with a method already in the object
  end
  ...
  def test_non_foo_messages_are_treated_normally
    ...
    assert_raise(NoMethodError) do # would call the super class with this same method, which doesn't exist
